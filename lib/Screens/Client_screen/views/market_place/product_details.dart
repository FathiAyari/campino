...
import 'package:myapp00/Authentication/Sign_up/alertTask.dart';
import 'package:myapp00/Screens/Client_screen/views/profile/profileScreen.dart';
import 'package:myapp00/Services/StoreServices.dart';
            ...
            children: [
              ...
              Stack(
                children: [
                  ...
                  Container(
                    height:
                        Constants.screenHeight - Constants.screenHeight * 0.35,
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Padding(
                                padding: EdgeInsets.symmetric(
                                    horizontal: Constants.screenWidth * 0.09),
                                child:
                                    Text("price : ${widget.product.price} DT"),
                              ),
                            ],
                          ),
                        ),
                                                    ...
                                                    if (value) {
                                                      ...
                                                      alertTask(
                                                        ...
                                                        lottieFile:
                                                            "images/error.json",
                                                        message:
                                                            "Votre produit est déja existe dans le panier",
                                                      ).show(context);
                                                    }
                                                  });
                                                },
